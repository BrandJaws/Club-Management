...
<head>
<meta charset="utf-8"/>
<title>Grit Dashboard - Forget Password</title>
...
<link href="{{asset('assets/admin/layout/css/themes/darkblue.css')}}" id="style_color" rel="stylesheet" type="text/css"/>
...
<div class="logo">
<a href="#.">
<img src="{{asset('assets/admin/layout/img/logo.png')}}" alt=""/>
</a>
</div>
<!-- END LOGO -->
...
<div class="input-icon">
<i class="fa fa-lock"></i>
<input class="form-control placeholder-no-fix" type="password" autocomplete="off" placeholder="Confirm Password" name="confirm-password"/>
</div>
</div>
<div class="form-actions">
<button type="submit" class="btn blue pull-right">Channge Password <i class="m-icon-swapright m-icon-white"></i></button>
<p>&nbsp;</p>
</div>
</form>
...
<!-- BEGIN COPYRIGHT -->
<div class="copyright">
� 2016. Design and Developed for Grit
</div>
