@extends('__layouts.admin') @section('main')
	...
	<div class="page-bar">
		<ul class="page-breadcrumb">
			...
			<li><a href="{{url('/court')}}">Trainers</a></li>
		</ul>
						...
						<div class="portlet-title">
							<div class="actions">
								<a href="{{route('court.create')}}"
								   class="btn red btn-outline btn-circle"> Add Trainer</a>
							</div>
						</div>
										...
										@if(!empty($data))
											@foreach((array)$data as $court)
												<tr>
													...
													<td><a style="padding: 5px 16px; width: 85px"
													       href="{{route('court.edit',['id'=>$court['id']])}}"
													       class="btn red btn-sm btn-circle btn-outline"> <i
