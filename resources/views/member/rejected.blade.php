                                        ...
                                        <tr>
                                            ...
                                            <td class="action-btns" style="width: 210px">
                                                {{--<div class="btn-group btn-group-circle" style="">--}}
                                                    <a style="padding: 5px 16px; width: 85px" href="{{route('member.approve',[array_get($member,'id')])}}" class="btn btn-outline green btn-sm btn-circle"><i class="fa fa-check"></i>&nbsp;Approve</a>
