		...
		<div class="profile-sidebar">
			...
			<div class="portlet light profile-sidebar-portlet " style="padding: 30px 0 30px!important">
				...
				<div class="profile-userpic">
					<img src="{{(isset($coach['profilePic']) && $coach['profilePic'])?$coach['profilePic']:'http://www.placehold.it/200x150/EFEFEF/AAAAAA&amp;text=no+image' }}" class="img-responsive" alt="">
				</div>
			</div>
			<!-- END PORTLET MAIN -->
		</div>
					...
					<div class="portlet light ">
						<div class="portlet-title tabbable-line">
							<div class="caption caption-md">
								...
								<span class="caption-subject font-red bold uppercase">Coach Profile</span>
							</div>
						...
						<div class="portlet-body">
							<div class="tab-content">
								...
								<div class="tab-pane active" id="tab_1_1">
									{!! Form::open(['route'=>['coaches.update',$coachId], 'id'=>'form-login','class'=>'login-form', 'method'=>'PUT','enctype'=>'multipart/form-data']) !!}
									...
									<div
										...
										{!! Form::text('firstName', (Input::old('firstName'))?Input::old('firstName'):(isset($coach['firstName'])?$coach['firstName']:''),['class'=>'form-control', 'placeholder'=>'First Name'] ) !!}
									...
									<div
										...
										{!! Form::text('lastName', (Input::old('lastName'))?Input::old('lastName'):(isset($coach['lastName'])?$coach['lastName']:''),['class'=>'form-control placeholder-no-fix','placeholder'=>'Last Name'] ) !!}
									...
									<div class="form-group {{($errors->has('email'))?'has-error':''}}">
										...
										{!! Form::email('email', (Input::old('email'))?Input::old('email'):(isset($coach['email'])?$coach['email']:''),['class'=>'form-control placeholder-no-fix','placeholder'=>'Email'] ) !!}
										@if($errors->has('email'))
									...
									<div class="form-group {{($errors->has('phone'))?'has-error':''}}">
										...
										{!! Form::number('phone', (Input::old('phone'))?Input::old('phone'):(isset($coach['phone'])?$coach['phone']:''),['class'=>'form-control placeholder-no-fix','placeholder'=>'+1 646 580 DEMO (6284)'] ) !!}
										@if($errors->has('phone'))
									...
									<div class="form-group coachSpecialitiesCls {{($errors->has('specialities'))?'has-error':''}}">
										...
										{!! Form::text('specialities', (Input::old('specialities'))?Input::old('specialities'):(isset($coach['specialities'])?$coach['specialities']:''),['class'=>'form-control placeholder-no-fix','placeholder'=>'Specialities', 'id'=>'coachSpecialities','data-role'=>'tagsinput'] ) !!}
