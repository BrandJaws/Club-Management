                        ...
                        <table class="table table-hover reservationsTabelVue">
                            ...
                            <tr>
                                ...
                                <th style="width: 141px;">
                                    <div >
                                        <select class="form-control input-circle input-sm" @change="bookingFilterSelectionChanged" v-model
                            ...
                            <tr   v-if="reservationIsNotRoutineTennisReservation(reservation)">
                                <td scope="row">@{{reservation.timeSlot }}</th>
                            ...
                            <tr v-else-if="reservation.reservations[0].captionsRowVisible && reservation.reservations[0].visibleBasedOnBookingStatusFilter"
                                ...
                                <td scope="row">@{{reservation.timeSlot }}</th>
                                <td class=""
                                    v-for="player in reservation.reservations[0].playersForBinding">@{{player.playerName }}</td>

                                <td class="text-center"><a class="btn btn-outline btn-circle btn-sm red csEditBtn" title="Edit" @click="
                                                            editButtonClicked(reservation.reservations[0])"><i class="fa fa-pencil"></i> Edit</a>
                                    &nbsp;</td>
                            </tr>
                            ...
                            >
                                <td scope="row">@{{reservation.timeSlot }}</th>
                                <td class="active-def"
                                    v-for="(player,playerIndex) in reservation.reservations[0].playersForBinding">
                                    ...
                                    :data-player-name="player.playerName" :data-player-id="player.playerId" ></td>

                                <td class="active-def">
                                    <div class="text-center">
                                        <a @click="cancelButtonClicked(reservation.reservations[0])" class="btn btn-outline btn-circle btn-sm red-thunderbird"><i class="fa fa-ban"></i></a>
                                        <a class="btn btn-outline btn-circle btn-sm green-jungle" title="Save" @click="saveButtonClicked(reservation,court.club_id,court.court_id)"><i class="fa fa-floppy-o"></i></a>
