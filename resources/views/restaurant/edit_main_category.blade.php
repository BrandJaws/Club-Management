...
<h1 class="page-title"> Edit Main Category</h1>
      ...
      <div class="col-md-12">
        <div class="portlet light">
          <div class="portlet-body">
            <form action="{{route('restaurant.update_main_category',$main_category['id'])}}"  method="post" enctype="multipart/form-data">
              ...
              <div class="form-group  {{($errors->has('icon'))?'has-error':''}}"> <!--<img src="{{asset($main_category['icon'])}}" alt="" class="img-thumbnail" />-->
                ...
                <div class="form-group  {{($errors->has('menu_icon'))?'has-error':''}}"> <!--<img src="{{asset($main_category['menu_icon'])}}" alt="" class="img-thumbnail" />-->
              ...
              <div class="fom-group text-right m-t-30">
                <button class="btn btn-lg red btn-outline btn-circle"> <i class="fa fa-floppy-o"></i> &nbsp;Update Main Category </button>
