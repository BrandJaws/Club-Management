...
@section('main')
	...
	<div ui-view class="app-body" id="view">
		...
		<!-- ############ PAGE START-->
		<div id="tab-accounts-vue-container" class="segments-main padding">
			...
			<div class="row">
				...
				<div class="segments-inner">
					<div class="box">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 col-sm-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="" class="form-control" v-model="filtersForBinding.email"/>
                                            </div>
                                        </div>
                        ...
                        @endif
						<!-- inner header -->
						<tab-accounts-list :tab-accounts-list="tabAccountsList" :base-url="baseUrl" v-on:error-update="errorUpdateHandler" v-on:success-update="successUpdateHandler"></tab-accounts-list>
					</div>
				</div>
            </div>
			</div>
...
@include("__vue_components.tab-accounts.tab-accounts-list")
...
<script>
    ...
    var vue = new Vue({
        ...
        data: {
            ...
            nullFilters:{ restaurantMainCategoryId:0, restaurantSubCategoryId:0, memberId:-1,  email:"", timeFrom:"",timeTo:"", },
            filtersReceived : ({!! $tabAccountsWithFilters !!}).filters != null ? ({!! $tabAccountsWithFilters !!}).filters : { restaurantMainCategoryId:0, restaurantSubCategoryId:0, memberId:-1,  email:"", timeFrom:"",timeTo:"", },
            filtersForBinding:{
            ...
            tabAccountsList: null,
            categories: ({!! $tabAccountsWithFilters !!}).mainCategories,
            ajaxRequestInProcess:false,
            nextAvailablePage:({!! $tabAccountsWithFilters!!}).next_page_url !== null ? 2 : null ,
        ...
        created:function(){
            this.tabAccountsList = this.processTabAccountsList(({!! $tabAccountsWithFilters !!}).data);
        },
        mounted:function(){

        },
        methods: {
            processTabAccountsList:function(tabAccountsList){
                try{
                    var tabAccountListClone = JSON.parse(JSON.stringify(tabAccountsList));

                    for(tabAccountIndex in tabAccountListClone){
                        var tabAccount = tabAccountListClone[tabAccountIndex];
                        tabAccount.editModeOn = false;
                        tabAccount.editedData = {
                            member_id_local:tabAccount.member_id_local,
                            email:tabAccount.email,
                ...
                if(!this.ajaxRequestInProcess){
                    ...
                    var request = $.ajax({
                        ...
                        success:function(msg){
                            ...
                            tabAccountsList = pageDataReceived.data ;
                            this.filtersReceived = pageDataReceived.filters != null ? pageDataReceived.filters : {  restaurantMainCategoryId:0, restaurantSubCategoryId:0, memberId:-1,  email:"", timeFrom:"",timeTo:"", };
                            ...
                            if(isSearchQuery){
                                ...
                                this.tabAccountsList= this.processTabAccountsList(tabAccountsList);
                            }else{

                                appendArray(this.tabAccountsList,this.processTabAccountsList(tabAccountsList));
                            }
