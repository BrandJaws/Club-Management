...
@section('main')
    ...
    <h1 class="page-title">Tab Deposits</h1>
	...
	<div ui-view class="app-body" id="view">
		<!-- ############ PAGE START-->
		<div id="tab-account-deposits-vue-container" class="segments-main padding">
			...
			<div class="row">
				...
				<div class="segments-inner">
					<div class="box">
                        ...
                        @endif
						<!-- inner header -->
						<tab-account-deposits-list :tab-account-deposits-list="tabAccountDepositsList" :base-url="baseUrl"></tab-account-deposits-list>
					</div>
				</div>
            </div>
			</div>
...
@include("__vue_components.tab-accounts.tab-account-deposits-list")
...
<script>
    ...
    var _baseUrl = "{{url('')}}";
    var vue = new Vue({
        el: "#tab-account-deposits-vue-container",
        data: {
            ...
            filtersReceived : ({!! $tabAccountDepositsWithFilters !!}).filters != null ? ({!! $tabAccountDepositsWithFilters !!}).filters : { restaurantMainCategoryId:0, restaurantSubCategoryId:0, memberId:-1,  email:"", timeFrom:"",timeTo:"", },
            filtersForBinding:{
            ...
            tabAccountDepositsList: ({!! $tabAccountDepositsWithFilters !!}).data,
            categories: ({!! $tabAccountDepositsWithFilters !!}).mainCategories,
            ajaxRequestInProcess:false,
            nextAvailablePage:({!! $tabAccountDepositsWithFilters!!}).next_page_url !== null ? 2 : null ,
            ...
            loadNextPage:function(isSearchQuery){
                ...
                if(!this.ajaxRequestInProcess){
                    ...
                    var request = $.ajax({
                        ...
                        url: this.baseUrl+'/tab-accounts/deposits',
                        method: "GET",
                        data:_data,
                        success:function(msg){
                            ...
                            tabAccountDepositsList = pageDataReceived.data ;
                            ...
                            if(isSearchQuery){
                                ...
                                this.tabAccountDepositsList=tabAccountDepositsList;
                            }else{

                                appendArray(this.tabAccountDepositsList,tabAccountDepositsList);
                            }
