                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="form-group {{($errors->has('name'))?'has-error':''}}">
                                ...
                                {!! Form::text('name', (isset($data['name']))?$data['name']:'', ['class'=>'form-control', 'placeholder'=>'Court Name'] ) !!}
                            ...
                            <div class="form-group {{($errors->has('bookingDuration'))?'has-error':''}}">
                                ...
                                {!!Form::select('bookingDuration', array('60' => '1hr', '120' =>'2hr'),(isset($data['bookingDuration']))?$data['bookingDuration']:'',['class'=>'form-control','placeholder'=>'Selected Time'] ) !!}
                            ...
                            <div class="form-group m-t-30 text-right">
                                {!! Form::button('Update Court', ['class'=>'btn red btn-lg btn-outline btn-circle', 'type'=>'submit']) !!}
                            </div>
                            <!-- </form> -->
                            {!! Form::close() !!}
                        </div>
