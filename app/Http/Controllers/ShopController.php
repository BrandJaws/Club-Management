...
class ShopController extends Controller {
	private $restService = [
		'index' => 'admin/shop',
		'saveCategory' => 'admin/shop/categories',
		'updateSubCategory' => 'admin/shop/categories/%s',
		'deleteSubCategory' => 'admin/shop/categories/%s',
		'saveNewProduct' => 'admin/shop/products/new',
		'editProduct' => 'admin/shop/products/%s/edit',
		'updateProduct' => 'admin/shop/products/%s',
		'deleteProduct' => 'admin/shop/products/%s',
		'getProductsByCategory' => 'admin/shop/products/by-category',
