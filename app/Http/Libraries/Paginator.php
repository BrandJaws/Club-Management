...
class Pagination {
	...
	public function paginate() {
		...
		if ($total_pages > $this->items_per_page) {
			$output .= ($current_page != 1 && $this->items_total >= $this->items_per_page) ? '<li><a class="paginate ' . $this->link_class . ' prev" href="' . $base_uri . $this->page_name . '=' . $prev_page . '">&laquo;</a></li>' : '<li class="disabled"><a class="' . $this->link_class . ' prev">&laquo;</a></li>';
			...
			for($i = 1; $i <= $total_pages; $i ++) {
				...
				if ($i == 1 || $i == $total_pages || in_array ( $i, $this->range )) {
					$output .= ($i == $current_page) ? '<li class="active"><a class="' . $this->link_class . ' ' . $this->link_active_class . '" title="Go to page ' . $i . ' of ' . $total_pages . '">' . $i . '</a></li>' : '<li><a class="' . $this->link_class . '" title="Go to page ' . $i . ' of ' . $total_pages . '" href="' . $base_uri . $this->page_name . '=' . $i . '">' . $i . '</a></li>';
				}
				if ($this->range [$this->mid_range - 1] < $total_pages - 1 && $i == $this->range [$this->mid_range - 1])
					$output .= '<li class="disabled"><a class="' . $this->link_class . '"> ... </a></li>';
			}
			$output .= (($current_page != $total_pages && $this->items_total >= $this->items_per_page) && (@$_GET [$this->page_name] != 'All')) ? '<li><a class="' . $this->link_class . ' next" href="' . $base_uri . $this->page_name . '=' . $next_page . '">&raquo;</a></li>' : '<li class="disabled"><a class="' . $this->link_class . ' next">&raquo;</a></li>';
		} else {
			$output .= '<li class="disabled"><a class="' . $this->link_class . ' prev">&laquo;</a></li>';
			for($i = 1; $i <= $total_pages; $i ++) {
				$output .= ($i == $current_page) ? '<li class="active"><a class="' . $this->link_class . ' ' . $this->link_active_class . '">' . $i . '</a></li>' : '<li><a class="' . $this->link_class . '" href="' . $base_uri . $this->page_name . '=' . $i . '">' . $i . '</a></li>';
			}
			$output .= '<li class="disabled"><a class="' . $this->link_class . ' next">&raquo;</a></li>';
		}
